...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'gradient-primary': 'linear-gradient(to right, #0ea5e9, #0284c7)',
        'gradient-primary-hover': 'linear-gradient(to right, #0284c7, #0369a1)',
        'dot': "url('/assets/dots.svg')",
      },
      backgroundColor: {
        'primary-light': 'rgba(14, 165, 233, 0.08)',
        'primary-lighter': 'rgba(14, 165, 233, 0.04)',
      },
      animation: {
